...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($uid) { // If everything's OK.
		...
		// Update the database:
		$q = "UPDATE users SET passw=SHA1('$p') WHERE user_id=$uid LIMIT 1";
		$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
...
<form action="forgot_password.php" method="post">
	<table>
	<tr>
	<td><b>Email Address:</b></td><td><input type="text" name="email" size="20" maxlength="60" value="<?php if (isset($_GET['e'])) echo $_GET['e']; ?>" /></td>
	</tr>
	<tr>
	<td></td>
